...
<script src="../static/js/jquery-3.5.1.min.js" type="text/javascript"
...
<form class="layui-form layui-form-pane" action="" lay-filter="form1">
		<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input name="bid" class="layui-input" type="text" autocomplete="off" lay-verify="bid" id="bid" disabled title="不可更改">
				</div>
			</div>
		<div class="layui-form-item">
		...
		<div class="layui-form-item">
			<div class="layui-input-block">
				<button class="layui-btn" lay-submit lay-filter="addForm">提交修改</button>
			</div>
		</div>
	</form>
		 		...
		 		success: function(data) {
		 			if(data.code==0){
						...
						form.val('form1',{
							...
							publishHouse: data.data.publishHouse,
							publishDate1:data.data.publishDate,
							isbn: data.data.isbn,
							price:data.data.price,
							briefIntr:data.data.briefIntr,
							typeId:data.data.typeId,
							imgName:data.data.imgName
						});
						$('#bookImg').attr('src',data.data.imgName);
		 			}
		 		},
		 		error: function(){
					layer.msg("服务器内部错误");
